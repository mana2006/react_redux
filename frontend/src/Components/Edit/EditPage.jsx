    ...
    <form onSubmit={handleSubmit}>
      <section className='edit-container'>
        ...
        <div className="input-container">
          <Input typeInput="text" label="Display name" className="edit-displayname" data={name} setData={setName} />
          <Input typeInput="text" label="Age" className="edit-age" data={age} setData={setAge} />
          <Input typeInput="textarea" label="About" className="edit-about" data={about} setData={setAbout} />
        </div>
        <div className="image-container">
          ...
          {avaUrl.map(image => {
            return (
              <>
                <img src={image} alt='' onClick={(e) => setImage(e.target.src)} className='image' width='100' height='140' />
              </>
            );
          })}
        ...
        <div className="theme-container">
          <Input typeInput="color" label="Theme" className="theme-color" data={themeColor} setData={setThemeColor} />
        </div>
      </section>
    </form>
